...
print(str1[5])      # 인덱스 접근 가능 : 시퀀스 형
print(str1[5:7])    # 슬라이싱
print(str1[5:])     # 생략하면 끝까지
print(str1[:6])      # 앞을 생략하면 처음부터
print(str1[:])       # 시퀀스 전체

# str1[0] = 'l'       # 변경 안됨 - 변경 불가 객체  # Type Error
...
# print("index() 없는 값 : ", str1.index("Java"))     # 찾는 내용이 없으면 value Error
...
print(s.split())
print(s.split(" and ")) #특정 문자열 기준으로 분리
